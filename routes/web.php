...
Route::get('/users', [UserManagementController::class, 'index'])
    ->middleware(['auth', 'permission:view users', 'active-permission:view users'])
    ->name('users');

Route::middleware(['auth', 'permission:manage users', 'active-permission:manage users'])->group(function () {
...
Route::middleware(['auth', 'permission:manage notifications'])->group(function () {
